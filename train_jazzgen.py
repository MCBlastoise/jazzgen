...
def make_training_pairs(rep_seq):
    ...
    if len(rep_seq) < MIN_SEQ_SIZE:
        ...
        for ix, _ in enumerate(rep_seq[:-1]):
            ...
            for jx in range(start_seq_idx, end_seq_idx):
                music_prefix = rep_seq[ start_seq_idx : jx + 1 ]
                next_sound = rep_seq[jx + 1 : jx + 2]
...
if __name__ == '__main__':
    ...
    # rep_seqs_filename = 'cached/dur_rep_seqs.pkl'
    # corpus_cache_filename = 'cached/dur_rep_corpus.pkl'
    # model_filename = 'cached/dur_model.pt'

    rep_seqs_filename = 'cached/dur2_rep_seqs.pkl'
    corpus_cache_filename = 'cached/dur2_rep_corpus.pkl'
